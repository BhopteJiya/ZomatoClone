...
const Collection2 = ({cities}) => {
  ...
  const CollectionArray = [
      {
        id:"1",
        label: "Luxury Dining Places",
        label2:" 21 Places",
        icon: coll1,
      },
      {
        id: "2",
        label: "Romantic Dining Places",
        label2:" 15 Places",
        icon: coll2,
      },
      {
  ...
  return (
    ...
    <div className=' flex flex-row justify-between mx-2 flex-wrap  sm:flex ' >
    <p
